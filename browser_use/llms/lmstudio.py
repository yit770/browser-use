...
class LMStudioLLM(BaseChatModel):
    ...
    max_input_tokens: int = context_length - max_tokens - 100  # Leave some room for the response
    ...
    def _convert_messages_to_prompt(self, messages: List[BaseMessage]) -> str:
        ...
        if self._output_schema is not None:
            ...
            prompt += '      "parameters": {"url": "https://www.google.com"}\n'
            prompt += '    }\n'
            prompt += '  ]\n'
            prompt += "}\n\n"
        ...
        logger.info(f"Remaining tokens for completion: {self.context_length - estimated_tokens}")
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                message = AIMessage(content=response_text, additional_kwargs=additional_kwargs)
            ...
            generation = ChatGeneration(
                message=message,
                generation_info={"finish_reason": response_json["choices"][0].get("finish_reason")}
            )
